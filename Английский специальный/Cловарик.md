...
| user-friendly              | простой в использоваании                                                                           |
| syntax                     | структура элементов и определений в языке                                                          |
| secure                     | защищённый от атак                                                                                 |
| object-oriented            | использующий методологию моделирования объектов, которые контролируются                            |
| inheritance                | наследование                                                                                       |
| standalone                 | работающий отдельно, независимо                                                                    |
| compatable with...         | совместимый с...                                                                                   |
| threads                    | потоки                                                                                             |
| portability                | характеристика, которая значит, что программа может использоваться на разных операционных системах |
| reliabiliy                 | надёжность                                                                                         |
